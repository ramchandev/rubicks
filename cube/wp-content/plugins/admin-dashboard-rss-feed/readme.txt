...
3.  On the left navigation, please go to Settings and, under that, click on the "Admin RSS Feed" page.
4.  Please fill the required information and save the settings.
5.  Once you are done with the settings, Visit your Dashboard to See the Latest News. Usually, this widget will be at the bottom, simply drag and drop to the top section.
...
Note that the screenshot is available under '/assets/screenshot-1.png' 

2. screenshot-2.png.
This is the second screenshot, which is available in '/assets/screenshot-2.png'
